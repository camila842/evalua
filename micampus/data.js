// ============================================
// MiCampus — Datos mock, iconos y helpers
// ============================================
...
const MOCK = {
  ...
  organizaciones: [
    { id: 'cadcc', nombre: 'CADCC', categoria: 'ce', categoriaLabel: 'Centro de Estudiantes', desc: 'Centro de Alumnos del Departamento de Ciencias de la Computación', miembros: 412 },
    { id: 'beauchef-brass', nombre: 'Beauchef Brass Band', categoria: 'cultural', categoriaLabel: 'Cultural', desc: 'Banda de música de vientos y percusión de la FCFM', miembros: 38 },
    { id: 'escalada', nombre: 'Escalada Beauchef', categoria: 'deportivo', categoriaLabel: 'Deportivo', desc: 'Comunidad de escalada en roca y boulder', miembros: 67 },
    { id: 'gmi', nombre: 'GMI', categoria: 'cultural', categoriaLabel: 'Cultural', desc: 'Grupo Musical de Ingeniería - tocatas, ensayos y talleres', miembros: 91 },
    { id: 'macumba', nombre: 'Macumba Batucada', categoria: 'cultural', categoriaLabel: 'Cultural', desc: 'Batucada, ritmos afro-latinoamericanos y carnaval', miembros: 54 },
    { id: 'volleybeauchef', nombre: 'VolleyBeauchef', categoria: 'deportivo', categoriaLabel: 'Deportivo', desc: 'Vóleibol mixto, todos los niveles bienvenidos', miembros: 82 },
    { id: 'kpop', nombre: 'KPop Beauchef', categoria: 'recreacion', categoriaLabel: 'Recreación', desc: 'Coreografías K-pop, presentaciones y comunidad', miembros: 73 },
    { id: 'sustenta', nombre: 'Sustenta Beauchef', categoria: 'sustent', categoriaLabel: 'Sustentabilidad', desc: 'Iniciativas medioambientales y restauración del campus', miembros: 45 },
    { id: 'rol', nombre: 'Club de Rol', categoria: 'recreacion', categoriaLabel: 'Recreación', desc: 'D&D, Pathfinder y juegos narrativos', miembros: 56 },
    { id: 'gbu', nombre: 'GBU', categoria: 'religioso', categoriaLabel: 'Religioso', desc: 'Grupo Bíblico Universitario', miembros: 28 },
    { id: 'antifoto', nombre: 'AntiFotografía', categoria: 'recreacion', categoriaLabel: 'Recreación', desc: 'Fotografía análoga, talleres y salidas', miembros: 41 },
    { id: 'cei', nombre: 'CEI', categoria: 'ce', categoriaLabel: 'Centro de Estudiantes', desc: 'Centro de Estudiantes de Ingeniería - representación FCFM', miembros: 5021 }
  ],

  eventos: [
    { id: 'e1', titulo: 'Tocata de Bienvenida Mechones 2026', org: 'GMI', orgId: 'gmi', categoria: 'cultural', fecha: '2026-04-29T20:00', ubicacion: 'Patio Beauchef 851', interesados: 234 },
    { id: 'e2', titulo: 'Charla: Carrera en Industria del Software', org: 'CADCC', orgId: 'cadcc', categoria: 'academic', fecha: '2026-04-30T18:30', ubicacion: 'Auditorio Gorbea', interesados: 89 },
    { id: 'e3', titulo: 'Salida de Escalada al Cajón del Maipo', org: 'Escalada Beauchef', orgId: 'escalada', categoria: 'deportivo', fecha: '2026-05-03T07:00', ubicacion: 'Encuentro: Acceso B850', interesados: 22 },
    { id: 'e4', titulo: 'Feria Empresarial DCC 2026', org: 'CADCC', orgId: 'cadcc', categoria: 'academic', fecha: '2026-05-08T10:00', ubicacion: 'Hall B851', interesados: 412 },
    { id: 'e5', titulo: 'Ensayo abierto Macumba', org: 'Macumba Batucada', orgId: 'macumba', categoria: 'cultural', fecha: '2026-04-28T19:00', ubicacion: 'Patio interior B851', interesados: 38 },
    { id: 'e6', titulo: 'Inscripciones Fondos FIPE 2026', org: 'CEI', orgId: 'cei', categoria: 'academic', fecha: '2026-05-15T23:59', ubicacion: 'Online', interesados: 156 },
    { id: 'e7', titulo: 'Torneo de Vóleibol Inter-Carreras', org: 'VolleyBeauchef', orgId: 'volleybeauchef', categoria: 'deportivo', fecha: '2026-05-10T15:00', ubicacion: 'Multicancha B851', interesados: 67 },
    { id: 'e8', titulo: 'Limpieza del Campus', org: 'Sustenta Beauchef', orgId: 'sustenta', categoria: 'sustent', fecha: '2026-05-04T11:00', ubicacion: 'Plazoleta B850', interesados: 49 },
    { id: 'e9', titulo: 'Sesión de D&D abierta', org: 'Club de Rol', orgId: 'rol', categoria: 'recreacion', fecha: '2026-05-02T16:00', ubicacion: 'Sala G108', interesados: 18 }
  ]
};

// =============================================================
// === LUCIDE ICONS — set vectorial (igual que Notion/Linear) ===
// =============================================================
const ICONS = {
  ...
  heartFilled:'<svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.29 1.51 4.04 3 5.5l7 7Z"/></svg>',
  ...
  leaf:       '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.96c1.4 9.3 4.1 15.04-3.2 17.04A7 7 0 0 1 11 20Z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></svg>',
  cross:      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 2a2 2 0 0 0-2 2v5H4a2 2 0 0 0-2 2v2c0 1.1.9 2 2 2h5v5c0 1.1.9 2 2 2h2a2 2 0 0 0 2-2v-5h5a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-5V4a2 2 0 0 0-2-2h-2z"/></svg>',
  ...
  paintBucket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m19 11-8-8-8.6 8.6a2 2 0 0 0 0 2.8l5.2 5.2c.8.8 2 .8 2.8 0L19 11Z"/><path d="m5 2 5 5"/><path d="M2 13h15"/><path d="M22 20a2 2 0 1 1-4 0c0-1.6 1.7-2.4 2-4 .3 1.6 2 2.4 2 4Z"/></svg>',
  // Categorías deportivas/culturales adicionales
...
function icon(name, sizeClass = '') {
  ...
  if (!svg) return '';
  return svg.replace('<svg ', `<svg class="ic ${sizeClass}" `);
}

// === Logo SVG ===
const LOGO_MARK = `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-label="MiCampus"><rect width="64" height="64" rx="12" fill="#FFD60A"/><rect x="4" y="4" width="56" height="56" rx="9" fill="none" stroke="#0A0A0A" stroke-width="1.5"/><path d="M 16 50 L 16 18 L 32 40 L 48 18 L 48 50" fill="none" stroke="#0A0A0A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="32" cy="40" r="3" fill="#0A0A0A"/></svg>`;

const LOGO_MARK_DARK = `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-label="MiCampus"><rect width="64" height="64" rx="12" fill="#0A0A0A"/><path d="M 16 50 L 16 18 L 32 40 L 48 18 L 48 50" fill="none" stroke="#FFD60A" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="32" cy="40" r="3" fill="#FFD60A"/></svg>`;
...
function fmtFechaRel(iso) {
  const d = new Date(iso);
  const ahora = new Date('2026-04-26T22:00:00');
  const diff = (d - ahora) / (1000 * 60 * 60);
  if (diff < 0) return 'Pasado';
  if (diff < 24) return `En ${Math.round(diff)}h`;
  if (diff < 24 * 7) return `En ${Math.round(diff / 24)} días`;
  return fmtFecha(iso);
}

function getOrg(id) { return MOCK.organizaciones.find(o => o.id === id); }
  ...
  return `
    <nav class="navbar">
      <div class="navbar-inner">
        <a href="mapa.html" class="logo">
          <span class="logo-mark">${LOGO_MARK_DARK}</span>
          <span class="logo-text">MiCampus</span>
        </a>
        <div class="nav-search">
          <span class="nav-search-icon">${ICONS.search}</span>
          <input type="text" placeholder="Buscar salas, eventos, organizaciones..." onkeydown="if(event.key==='Enter') location.href='buscar.html?q='+encodeURIComponent(this.value)">
        </div>
        <div class="nav-links">
          <a href="mapa.html"           class="nav-link ${activePage==='mapa'?'active':''}">Mapa</a>
          <a href="eventos.html"        class="nav-link ${activePage==='eventos'?'active':''}">Eventos</a>
          <a href="organizaciones.html" class="nav-link ${activePage==='organizaciones'?'active':''}">Organizaciones</a>
          <a href="mis-favoritos.html"  class="nav-link ${activePage==='favoritos'?'active':''}">Favoritos</a>
        </div>
        <div class="nav-user">
          <button class="nav-icon-btn" title="Notificaciones" onclick="showToast('Tienes 3 notificaciones nuevas')">
            ${ICONS.bell}
            <span class="nav-dot"></span>
          </button>
          <a href="mis-favoritos.html" title="${MOCK.user.name}" class="nav-avatar">${MOCK.user.initials}</a>
        </div>
      </div>
    </nav>
  `;
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer-brand">
          ...
          <p class="footer-text">Plataforma única de información del Campus Beauchef · Universidad de Chile</p>
        </div>
        ...
        <div class="footer-col">
          <h5>Información</h5>
          <a href="#">Sobre MiCampus</a>
          <a href="#">SAE · CEI · CEPC</a>
          <a href="#">Contacto</a>
        </div>
        <div class="footer-col">
          <h5>Legal</h5>
      ...
      <div class="footer-bottom">
        © 2026 FCFM · Universidad de Chile · MiCampus es un proyecto del curso CC4402
      </div>
    </footer>
  `;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (navSlot) navSlot.innerHTML = renderNavbar(navSlot.dataset.page || '');
...
function showToast(msg, iconName = 'check') {
  ...
  t.className = 'toast';
  const ic = ICONS[iconName] ? `<span class="toast-icon">${ICONS[iconName]}</span>` : '';
